...
<button class="bg-transparent hover:bg-orange-100 hover:text-orange-700 font-semibold hover:text-white py-2 px-4 border border-orange-900 hover:border-transparent rounded">
